...
export const MESSAGE_TYPES = {
  ...
  COMPILE_CONVERSATION: "skillclip/compile-conversation",
  COMPILE_SELECTIONS: "skillclip/compile-selections",
  INSERT_SKILL: "skillclip/insert-skill",
  APPROVE_DRAFT_PREVIEW: "skillclip/approve-draft-preview",
  ...
  RESTORE_CONVERSATION: "skillclip/restore-conversation",
  RESTORE_DRAFT: "skillclip/restore-draft",
  RESTORE_SKILL: "skillclip/restore-skill",
  DELETE_CONVERSATION: "skillclip/delete-conversation",
  DELETE_DRAFT: "skillclip/delete-draft",
  DELETE_SKILL: "skillclip/delete-skill",
  DELETE_VARIANT: "skillclip/delete-variant",
  UPDATE_CONVERSATION: "skillclip/update-conversation",

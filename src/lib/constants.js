...
export const MESSAGE_TYPES = {
  ...
  OPTIMIZE_CONVERSATION: "skillclip/optimize-conversation",
  OPTIMIZE_WORKFLOW_PROMPT: "skillclip/optimize-workflow-prompt",
  UPDATE_WORKFLOW_PROMPT: "skillclip/update-workflow-prompt",
